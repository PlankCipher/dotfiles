...
EOF
  ...
  yay -S hyprland-git xdg-desktop-portal-hyprland-git hyprland-qt-support-git swaylock-effects swaybg wl-clipboard brightnessctl lxsession xf86-video-amdgpu dunst libnotify qt5-wayland qt6-wayland gnome-themes-extra bibata-cursor-theme swayidle
