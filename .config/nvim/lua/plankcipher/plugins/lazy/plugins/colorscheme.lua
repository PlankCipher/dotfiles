  ...
  config = function()
    ...
    require('rose-pine').setup({
      ...
      highlight_groups = {
        ...
        BlinkCmpMenu = {link = 'NormalFloat', inherit = false},
        BlinkCmpMenuBorder = {link = 'FloatBorder', inherit = false},
        BlinkCmpMenuSelection = {link = 'PmenuSel', inherit = false},
        BlinkCmpDoc = {link = 'BlinkCmpMenu', inherit = false},
        BlinkCmpDocBorder = {link = 'BlinkCmpMenuBorder', inherit = false},
        BlinkCmpDocSeparator = {fg = 'subtle', inherit = false},
        BlinkCmpSignatureHelp = {link = 'BlinkCmpMenu', inherit = false},
        BlinkCmpSignatureHelpBorder = {link = 'BlinkCmpMenuBorder', inherit = false},
        BlinkCmpGhostText = {fg = 'subtle', bg = '#000000', inherit = false},
        BlinkCmpKind = {fg = 'base', bg = 'love', italic = true, inherit = false},
        BlinkCmpLabel = {fg = 'text', inherit = false},
        BlinkCmpLabelMatch =  {fg = 'love', inherit = false},
        BlinkCmpLabelDetail = {fg = 'subtle', inherit = false},
        BlinkCmpLabelDeprecated = {fg = 'subtle', strikethrough = true, inherit = false},
        BlinkCmpSourceIcon = {fg = 'base', bg = 'subtle', italic = true, inherit = false},

        BlinkCmpKindClass = {fg = 'base', bg = 'gold', italic = true, inherit = false},
        BlinkCmpKindColor = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindConstant = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindConstructor = {fg = 'base', bg = 'love', italic = true, inherit = false},
        BlinkCmpKindEnum = {fg = 'base', bg = 'gold', italic = true, inherit = false},
        BlinkCmpKindEnumMember = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindEvent = {fg = 'base', bg = 'gold', italic = true, inherit = false},
        BlinkCmpKindField = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindFile = {fg = 'base', bg = 'rose', italic = true, inherit = false},
        BlinkCmpKindFolder = {fg = 'base', bg = 'rose', italic = true, inherit = false},
        BlinkCmpKindFunction = {fg = 'base', bg = 'pine', italic = true, inherit = false},
        BlinkCmpKindInterface = {fg = 'base', bg = 'gold', italic = true, inherit = false},
        BlinkCmpKindKeyword = {fg = 'base', bg = 'love', italic = true, inherit = false},
        BlinkCmpKindMethod = {fg = 'base', bg = 'pine', italic = true, inherit = false},
        BlinkCmpKindModule = {fg = 'base', bg = 'rose', italic = true, inherit = false},
        BlinkCmpKindOperator = {fg = 'base', bg = 'love', italic = true, inherit = false},
        BlinkCmpKindProperty = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindReference = {fg = 'base', bg = 'iris', italic = true, inherit = false},
        BlinkCmpKindSnippet = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindStruct = {fg = 'base', bg = 'gold', italic = true, inherit = false},
        BlinkCmpKindText = {fg = 'base', bg = 'gold', italic = true, inherit = false},
        BlinkCmpKindTypeParameter = {fg = 'base', bg = 'iris', italic = true, inherit = false},
        BlinkCmpKindUnit = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindValue = {fg = 'base', bg = 'foam', italic = true, inherit = false},
        BlinkCmpKindVariable = {fg = 'base', bg = 'foam', italic = true, inherit = false},
