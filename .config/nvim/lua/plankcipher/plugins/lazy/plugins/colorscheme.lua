  ...
  config = function()
    ...
    require('rose-pine').setup({
      ...
      highlight_groups = {
        ...
        ['@keyword.storage'] = {link = 'Type', inherit = false},
        ...
        ['@markup.link.label.url'] = {fg = 'iris', underline = true, inherit = false},
        ...
        CmpItemKindField = {link = '@variable.member', inherit = false},
        CmpItemKindFile = {link = '@keyword.import', inherit = false},
        CmpItemKindFolder = {link = '@keyword.import', inherit = false},
        ...
        CmpItemKindMethod = {link = '@function.method', inherit = false},
        CmpItemKindModule = {link = '@keyword.import', inherit = false},
        CmpItemKindNamespace = {link = '@module', inherit = false},
        CmpItemKindNull = {link = '@constant', inherit = false},
        CmpItemKindNumber = {link = '@number', inherit = false},
        CmpItemKindObject = {link = '@keyword.storage', inherit = false},
        CmpItemKindOperator = {link = '@operator', inherit = false},
        CmpItemKindPackage = {link = '@keyword.import', inherit = false},
        CmpItemKindProperty = {link = '@property', inherit = false},
        CmpItemKindReference = {link = '@variable.parameter.reference', inherit = false},
        ...
        CmpItemKindTypeParameter = {link = '@variable.parameter', inherit = false},
        CmpItemKindUnit = {link = '@constant', inherit = false},
        CmpItemKindValue = {link = '@constant', inherit = false},
        CmpItemKindVariable = {link = '@variable.member', inherit = false},
