...
set_timeout () {
  ...
  swayidle -w \
    timeout $LOCK_TIMEOUT_SECS 'swaylock -f -e -F -L -K -r --font "LigaSFMono" --bs-hl-color eb6f92 --separator-color 00000000 --key-hl-color 9ccfd8 --inside-color 1d1b2c --ring-color 3a4454 --text-color e0def4 --inside-clear-color 4f413d --ring-clear-color f6c177 --text-clear "Cleared" --text-clear-color e0def4 --inside-ver-color 25364a --ring-ver-color 3e8fb0 --text-ver "Verifying" --text-ver-color e0def4 --inside-wrong-color 4c2e43 --ring-wrong-color eb6f92 --text-wrong "Wrong" --text-wrong-color e0def4 -i ~/.config/hypr/lockscreen.png --effect-blur 10x10 --indicator --indicator-radius 90' \
